...
def download_remote_fonts(lang: str):
    ...
    # Try to get font path from config, fallback to default location
    try:
        ...
        logger.debug(f"Could not get font path from config: {e}")
    ...
    try:
        ...
        logger.warning(f"Could not download font {font_name}: {e}. Using default font handling.")
        # Return a default path that will be handled by the font system
        return None
